...
const leaders = [
  { name: "James Chen", role: "Chief Executive Officer", bio: "25+ years in global supply chain management. Previously led Asia-Pacific operations for a Fortune 500 retailer." },
  { name: "Sarah Lin", role: "Chief Operating Officer", bio: "Expert in supply chain transformation and digital operations. Oversaw the integration of AI across LianZhou's platform." },
